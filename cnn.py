...
TRAIN_DIR = '/Users/rehanqureshi/Desktop/Major_Project/code/dataset/train/'
TEST_DIR = '/Users/rehanqureshi/Desktop/Major_Project/code/dataset/test/'
IMAGE_SIZE = 176
CLASSES = [
    'NonDemented',
    'VeryMildDemented',
...
se_callback = SnapshotEnsemble(n_models=1, n_epochs_per_model=24, lr_max=.03)
history = model.fit(
            imagegen.flow(train_ros_data, train_ros_labels, 
            batch_size=32), 
            steps_per_epoch=math.ceil(len(train_ros_data) / 32),
